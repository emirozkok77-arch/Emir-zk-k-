...
# --- 📋 MÜFREDAT (YÜKLEDİĞİN DOSYADAKİ TAM LİSTE) ---
CIZELGE_DETAY = {
    "MATEMATİK-1 (TYT)": [
        "Sayı Kümeleri", "Sayı Basamakları", "Asal Sayılar - Faktöriyel", "Bölme - Bölünebilme", 
        "EBOB - EKOK", "Rasyonel Sayılar", "1. Dereceden Denklemler", "Basit Eşitsizlikler", 
        "Mutlak Değer", "Üslü Sayılar", "Köklü Sayılar", "Oran - Orantı", "Sayı - Kesir Problemleri", 
        "Yaş Problemleri", "İşçi Problemleri", "Hareket Problemleri", "Yüzde - Kar - Zarar Problemleri", 
        "Karışım Problemleri", "Grafik Problemleri", "Sayısal Yetenek Problemleri", "Kümeler", 
        "Mantık", "Binom", "Permütasyon", "Kombinasyon", "Olasılık", "Polinom (TYT)"
    ],
    "MATEMATİK-2 (AYT)": [
        "Fonksiyonlar", "Fonksiyon Uygulamaları", "Parabol", "2. Dereceden Denklemler", 
        "Eşitsizlikler", "Trigonometri-1", "Trigonometri-2", "Logaritma", "Diziler", 
        "Limit ve Süreklilik", "Türev Alma Kuralları", "Türev - Teğet/Normal", 
        "Türev - Artan/Azalan/Ekstremum", "Maksimum - Minimum Problemleri", 
        "İntegral Alma Kuralları", "Belirli İntegral", "İntegral ile Alan Hesabı"
    ],
    "GEOMETRİ": [
        ...
        "Katı Cisimler (Prizma/Piramit/Küre)", "Noktanın Analitiği", "Doğrunun Analitiği", 
        "Dönüşüm Geometrisi", "Çember Analitiği"
    ],
    "FİZİK": [
        "Fiziğin Doğası", "Vektör - Kuvvet", "Denge - Tork", "Kütle Merkezi", "Basit Makineler", 
        "Madde ve Özellikleri", "Kaldırma Kuvveti", "Basınç", "Isı ve Sıcaklık", "Genleşme", 
        "Doğrusal Hareket", "Bağıl Hareket", "Dinamik (Newton)", "Atışlar", "İş - Güç - Enerji", 
        "İtme ve Momentum", "Düzgün Çembersel Hareket", "Basit Harmonik Hareket", "Açısal Momentum", 
        "Kütle Çekim ve Kepler", "Elektrostatik", "Elektrik Alan ve Potansiyel", "Paralel Levhalar", 
        "Sığaçlar", "Elektrik Akımı", "Manyetizma", "Manyetik Kuvvet", "İndüksiyon", 
        "Alternatif Akım ve Transformatör", "Optik - Aydınlanma/Gölge", "Optik - Aynalar", 
        "Optik - Kırılma/Mercekler", "Dalgalar (Yay/Su/Ses)", "Su Dalgalarında Girişim", "Işık Teorileri", 
        "Fotoelektrik Olay", "Atom Modelleri", "Büyük Patlama ve Radyoaktivite", "Modern Fizik"
    ],
    "KİMYA": [
        "Kimya Bilimi", "Atom ve Yapısı", "Modern Atom Teorisi", "Periyodik Sistem", 
        "Kimyasal Türler Arası Etkileşimler", "Mol Kavramı", "Kimyasal Hesaplamalar", 
        "Maddenin Halleri", "Gazlar", "Karışımlar", "Sıvı Çözeltiler", "Asitler, Bazlar ve Tuzlar", 
        "Kimyasal Tepkimelerde Enerji", "Kimyasal Tepkimelerde Hız", "Kimyasal Denge", 
        "Asit - Baz Dengesi", "Çözünürlük Dengesi", "Kimya ve Elektrik", "Organik Kimyaya Giriş", 
        "Organik Bileşikler", "Kimya Her Yerde"
    ],
    "BİYOLOJİ": [
        ...
        "Mayoz ve Eşeyli Üreme", "Kalıtım", "Ekosistem Ekolojisi", "Sinir Sistemi", 
        "Endokrin Sistem", "Duyu Organları", "Destek ve Hareket Sistemi", "Sindirim Sistemi", 
        "Dolaşım Sistemi", "Solunum Sistemi", "Üriner Sistem", "Üreme Sistemi", 
        "Komünite ve Popülasyon Ekolojisi", "Protein Sentezi", "Canlılık ve Enerji (Fotosentez/Solunum)", 
        "Bitki Biyolojisi"
    ],
    "TÜRKÇE": [
        "Sözcükte Anlam", "Cümlede Anlam", "Paragraf", "Ses Bilgisi", "Yazım Kuralları", 
        "Noktalama İşaretleri", "Sözcük Türleri (İsim/Sıfat/Zamir/Zarf)", "Edat - Bağlaç - Ünlem", 
        "Fiiller", "Ek Fiil", "Fiilimsiler", "Cümlenin Ögeleri", "Cümle Türleri", 
        "Anlatım Bozukluğu"
    ]
}
...
def init_files():
    ...
    # 1. ÇALIŞMA VERİLERİ (HATA KORUMALI)
...
if st.session_state.page == 'landing' and not st.session_state.logged_in:
    ...
    with col2:
        ...
        <div class="highlight-box" style="background: rgba(59, 130, 246, 0.1); border-left: 5px solid #3b82f6; padding: 20px; margin: 20px 0;">
    ...
    with c_team2:
        st.markdown("""<a href="https://teams.live.com/l/community/FEA37u2Ksl3MjtjcgY" style="display:block; width:100%; padding:20px; background:linear-gradient(90deg, #2563eb, #1d4ed8); color:white; text-align:center; border-radius:8px; text-decoration:none; font-weight:bold;" target="_blank">🚀 MICROSOFT TEAMS TOPLULUĞUNA KATIL</a>""", unsafe_allow_html=True)
...
# ==========================================
    ...
    # --- YENİ ÖDEV ATAMA PANELİ (SENİN ÇİZELGENE GÖRE) ---
        ...
        if st_list:
            ...
            # 2. ÖDEV VERME (DOSYANDAKİ KONULARLA)
            st.write("---")
            ...
            if bks:
                ...
                # ADIM 2: DERS SEÇ (DOSYADAKİ DERSLER)
                secilen_ders = col_sel2.selectbox("Ders Seç", list(CIZELGE_DETAY.keys()))
                
                # ADIM 3: KONU SEÇ (DOSYADAKİ DETAYLI KONULAR)
                # Dersi seçince, o dersin altındaki konuları listeden çekiyoruz
                ...
                if st.button("ÖDEVİ GÖNDER", use_container_width=True):
                    ...
                    # Görev metni artık test numarası
